...
`docs/notes/driver-code-walkthrough.zh.md`（`/dev/acq0` 那一侧是怎么实
...
事，这是纯靠约定对齐的（`docs/notes/learning-qa.md` Q25 讲过 `/dev/acq0`
...
是那套固定套路**（`docs/notes/systems-programming-patterns.md` 有通用版
...
间"MCU 掉线了"（`docs/notes/learning-qa.md` Q25 讨论过这个限制），所以只
